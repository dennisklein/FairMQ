...
FairMQ development happens here on Github via Pull Requests against the `dev` branch. Anyone is welcome to open a PR. For
questions, feature requests, or bug reports please use a [GH Issue](https://github.com/FairRootGroup/FairMQ/issues). Check
the [GH Dicussions](https://github.com/FairRootGroup/FairMQ/discussions) for announcements and public discussions.
