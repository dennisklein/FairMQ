...
TEST(Exceptions, static_InStop)
{
    EXPECT_EXIT(RunExceptionIn("Stop", "static"), ::testing::ExitedWithCode(1), "");
}
...
TEST(Exceptions, interactive_InStop)
{
    EXPECT_EXIT(RunExceptionIn("Stop", "interactive"), ::testing::ExitedWithCode(1), "");
}
