...
TEST(Signal_SIGINT, static_InStop)
{
    EXPECT_EXIT(RunSignalIn("Stop", "static"), ::testing::ExitedWithCode(0), "");
}
...
TEST(Signal_SIGINT, interactive_InStop)
{
    EXPECT_EXIT(RunSignalIn("Stop", "interactive"), ::testing::ExitedWithCode(0), "");
}
